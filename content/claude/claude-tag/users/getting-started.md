...
The instruction saves to [channel memory](/docs/claude-tag/users/memory) and applies to everyone's threads in the channel. Verify with "what do you remember about this channel?"
