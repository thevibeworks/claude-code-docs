...
| Plugin skills        | Skills from the plugins you provision through [organization plugins](/docs/third-party/claude-desktop/extensions#organization-plugins-admin) or [plugin marketplaces](/docs/third-party/claude-desktop/extensions#plugin-marketplaces-admin) are available in Chat, including as slash commands. Plugin sub-agents and hooks do not run in Chat, and a skill that runs scripts needs [advanced file analysis](#advanced-file-analysis). Requires Claude Desktop 1.44121.4 or later. |
