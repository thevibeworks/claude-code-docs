...
> Connect Claude to MCP servers inside your private network without opening inbound firewall ports or exposing the servers to the internet.
...
## Decide when to use an MCP tunnel
...
If the MCP server is already reachable from the internet, you don't need a tunnel. Add it as a [custom connector](/docs/connectors/custom/add-unlisted#add-a-connector-by-url) directly.

## Understand how tunnel traffic flows
...
* [Set up an MCP tunnel](/docs/connectors/mcp-tunnels/setup): create the API key, deploy the tunnel stack with Helm or Docker Compose, and add your servers as connectors
* [Authenticate through a tunnel](/docs/connectors/mcp-tunnels/oauth): make OAuth sign-in work when your authorization server is inside your network
* [Troubleshooting](/docs/connectors/mcp-tunnels/troubleshooting): diagnose connection, certificate, routing, and sign-in failures
* [Platform reference](https://platform.claude.com/docs/en/agents-and-tools/mcp-tunnels/reference): proxy configuration fields, certificate requirements, and the setup component
