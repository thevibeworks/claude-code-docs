Title: Use Claude with iOS apps

URL Source: https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps

Markdown Content:
# Use Claude with iOS apps | Claude Help Center

[Skip to main content](https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps#main-content)
...
3.   [Claude for iOS](https://support.claude.com/en/collections/9879000-claude-for-ios) 
4.   Use Claude with iOS apps
...
[What can Claude do with iOS apps?](https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps#h_3148856c2e)[How Claude helps you take action](https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps#h_0b3b74f95b)[Accessing and analyzing your health data](https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps#h_21f4b10d6d)[Usage guidelines for optimal results](https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps#h_434b5bfc5d)[What data can Claude access?](https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps#h_bca900eafe)[Do I need to grant permission to Claude for iOS?](https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps#h_719ceb0000)[Troubleshooting](https://support.claude.com/en/articles/11869619-use-claude-with-ios-apps#h_f113e61955)
