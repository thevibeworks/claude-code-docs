...
*   Local MCP server support in the [Claude Desktop apps](https://claude.ai/redirect/website.v1.49f47a19-6cda-4d2e-96b9-7cef7cb03e55/download)
...
Developers can start building and testing MCP connectors today. All [Claude.ai](http://claude.ai/redirect/website.v1.49f47a19-6cda-4d2e-96b9-7cef7cb03e55) plans support connecting MCP servers to the Claude Desktop app.
...
*   Install pre-built MCP servers through the [Claude Desktop app](https://claude.ai/redirect/website.v1.49f47a19-6cda-4d2e-96b9-7cef7cb03e55/download)
