...
| --- | --- | --- |
| **Provide verification criteria** | _”implement a function that validates email addresses"_ | _"write a validateEmail function. example test cases: [[email protected]](https://www.anthropic.com/cdn-cgi/l/email-protection#8efbfdebfcceebf6efe3fee2eba0ede1e3) is true, invalid is false, [[email protected]](https://www.anthropic.com/cdn-cgi/l/email-protection#2b5e584e596b05484446) is false. run the tests after implementing”_ |
