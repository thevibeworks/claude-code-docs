...
| Run Claude on a recurring schedule | [Cloud scheduled tasks](https://code.claude.com/docs/en/web-scheduled-tasks) or [Desktop scheduled tasks](https://code.claude.com/docs/en/desktop-scheduled-tasks) |
