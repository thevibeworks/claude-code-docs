...
| --- | --- | --- |
| **Provide verification criteria** | _”implement a function that validates email addresses"_ | _"write a validateEmail function. example test cases: [[email protected]](https://www.anthropic.com/cdn-cgi/l/email-protection#a8dddbcddae8cdd0c9c5d8c4cd86cbc7c5) is true, invalid is false, [[email protected]](https://www.anthropic.com/cdn-cgi/l/email-protection#add8dec8dfed83cec2c0) is false. run the tests after implementing”_ |
