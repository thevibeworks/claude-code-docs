...
This also makes [claude.ai](http://claude.ai/redirect/website.v1.e4b3d309-ea13-48d1-a73e-67a67616c849) subject to a more traditional threat model. We're not protecting user machines from agents; we're protecting our own infrastructure and each tenant from one another. Our pre-launch work for [claude.ai](http://claude.ai/redirect/website.v1.e4b3d309-ea13-48d1-a73e-67a67616c849) was dominated by traditional security work like network configuration, internal service auth, and orchestration.
